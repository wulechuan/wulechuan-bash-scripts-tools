...
___tempShouldTryLoadGNU__git_ps1=1
...
unset ___tempShouldTryLoadGNU__git_ps1
...
function _customize_prompt_with_git_branch_info_in_256_colors_ {
	...
	PS1="${PS1}\e[38;5;16;48;5;49m$(getCurrentUserName)"   # user
	...
	PS1=$PS1`__get_git_ps1_or_empty_string_in_256_colors`  # git branch info
...
function __get_git_ps1_or_empty_string_in_256_colors {
...
function __get_git_ps1_or_empty_string_in_16_colors {
	local gitBranchInfo=`__git_ps1`
	# local gitBranchInfo=`__parse_git_branch_info__`
